...
public final class LockSmith {
    ...
    public lazy var pid: PID = { process.pid }()
    /// The name of the current swift process
    public lazy var name: String = { process.name }()
    /// The arguments of the current swift process
    public lazy var arguments: [String]? = { process.arguments }()
    /// The username that ran the current swift process
    public lazy var username: String = { process.username }()
